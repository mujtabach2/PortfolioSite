    ...
    return (
      ...
      <Container maxW={''} p={6.75} mt={[20, 10]}>
        <div id="about" style={{ padding: '80px 0', color: '#ababab' }}>
          ...
          >
            <div className="about-col-1" style={{ flexBasis: '40%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img
                src={headshot}
                alt="About Me"
                style={{
            ...
            <div style={{flexBasis:'5%'}}></div>
              ...
              <div className="about-col-2" style={{ flexBasis: '50%', width: '10%',alignItems:'center', justifyContent: 'center' }}>
                <div>
                <h1
