...
// import { useQuoteAnimation } from "../assets/useQuoteAnimation";
  ...
  return style === "withBG" ? (
    <React.Fragment>
      <section className="quote-banner relative overflow-x-clip z-[1]">
        <div
          className="quote-outer-container bg-[--darkblue] h-[10vh] -rotate-3 flex justify-center items-center scale-110 max-lg:h-full min-[1921px]:px-96"
          style={{
            backgroundImage: `url(})`,
